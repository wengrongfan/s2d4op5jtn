                    ...
                    <div class="content">
                        <ul>
                            <?php if(is_array($news_list)): foreach($news_list as $key=>$v): ?><li>
                                <div class="time"><?php echo date('Y-m-d H:i', $v['news_time']); ?></div>
                                <div class="title">
                                    <a href="<?php echo U('Info/view', array('id' => $v['n_id']));?>"><?php echo ! empty($v['news_titleshort']) ? subtext($v['news_titleshort'], 35) : subtext($v['news_title'], 35); ?></a>
                                </div>
    ...
    <ul class="i_ma clearfix" style="background">
        ...
        <li>
            <a href="<?php echo U('Info/index', array('id' => C('CONTENT_HEALTHY')));?>">
                <img src="/Public/static/pic6.jpg" alt=""/>
            </a>
            <div class="title">
