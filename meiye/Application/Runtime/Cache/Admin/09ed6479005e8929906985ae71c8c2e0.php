...
var $type=$('#type').val();
var $mess=$('#mess');
$.post('/index.php/Admin/Staff/clear',{type:$type},function(data){
alert("缓存清理成功");
});
}else{
return false;
      ...
      <script type="text/javascript" src="/Public/sldate/daterangepicker.js"></script>
               ...
               $(document).ready(function() {
                  $('#reservation').daterangepicker(null, function(start, end, label) {
					...
					<form name="admin_list_sea" class="form-search form-horizontal" method="post" action="/index.php/Admin/Staff/list">
	  ...
	  <option value="0" <?php if($opentype_check == '0'): ?>selected="selected"<?php endif; ?> >关闭</option>
							...
							<div class="col-xs-12 col-sm-3 btn-sespan">
							  ...
							  <div class="input-group-btn">
								<a href="/index.php/Admin/Staff/list">
...
function del(id,p){
	    ...
	    layer.close(index);
	    window.location.href="/index.php/Admin/Staff/news_list_del/n_id/"+id+"/p/"+p+"";//重新获取当前页面，删除后返回当前页码
	});
}
