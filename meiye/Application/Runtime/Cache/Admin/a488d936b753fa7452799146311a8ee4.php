						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									修改<strong><?php echo ($adminnav["adminnav_title"]); ?></strong>导航信息
								</small>
							</h1>
						</div>
	...
	function complete(data){
		if(data.status==1){
			...
			return false;	
						...
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" name="admin_rule_edit" id="admin_rule_edit" method="post" action="<?php echo U('admin_rule_runedit');?>">
                                <input type="hidden" name="id" value="<?php echo ($rule["id"]); ?>" />
                                    
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 导航标题： </label>
										<div class="col-sm-9">
											<input type="text" name="title" id="title"  value="<?php echo ($rule["title"]); ?>"  class="col-xs-10 col-sm-5" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="name" id="name"  value="<?php echo ($rule["name"]); ?>"  class="col-xs-10 col-sm-5" />
                                            <span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9" style="padding-top:5px;">
											<input name="status" value="1"  <?php if($rule['menustatus'] == 1): ?>checked<?php endif; ?>  class="ace ace-switch ace-switch-5" type="checkbox" />
                                            <span class="lbl"></span>
										</div>
									</div>
                                    <div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="sort" id="sort"  value="<?php echo ($rule["sort"]); ?>" class="col-xs-10 col-sm-1" />
										</div>
									</div>
                                    <div class="space-4"></div>
